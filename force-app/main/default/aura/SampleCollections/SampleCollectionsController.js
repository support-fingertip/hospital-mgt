    ...
    createComplaint : function (component, event, helper) {
     ...
     createCompetition : function (component, event, helper) {
      ...
      createStoreStock : function (component, event, helper) {
        var createRecordEvent = $A.get("e.force:createRecord");
        createRecordEvent.setParams({
            "entityApiName": "Store_Stock__c"
            
        });
        createRecordEvent.fire();
    }, 
      createSample : function (component, event, helper) {
        var createRecordEvent = $A.get("e.force:createRecord");
        var enq=    component.get('v.data.currentvisit.Patient__c');
          
          alert(enq)
        createRecordEvent.setParams({
            "entityApiName": "Sample__c",
            "defaultFieldValues": {
                'Diagnostics_Test__c' : 'a0U2w00000ZSX9nEAH',
                'Patient__c' : enq,
